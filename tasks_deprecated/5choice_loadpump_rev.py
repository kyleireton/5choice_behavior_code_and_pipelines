...
v.session_duration = 2*minute      # Session duration
v.steps_rate = 250                 # this is step rate for stepper motor if you want to use peristaltic pump it will be 1000
v.n_steps = 100000                # this is number of steps for stepper motor if you want to use peristaltic pump it will be 1000
...
def start(event):
    ...
    if event =='entry':
        ...
        print('Trial_start')
        #hw.syringe_pump.stop()
        hw.speaker.off()
        goto_state('taste_task')
