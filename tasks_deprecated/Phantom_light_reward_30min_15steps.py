...
v.steps_rate = 200                 # this is step rate for stepper motor if you want to use peristaltic pump it will be 1000
v.n_steps = 15                    # this is number of steps for stepper motor if you want to use peristaltic pump it will be 1000
