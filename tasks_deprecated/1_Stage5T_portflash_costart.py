...
v.n_steps = 840                    # this is number of steps for stepper motor if you want to use peristaltic pump it will be 1000
...
v.ITI_dur = 5*second                # this state the duration of the Intra_trail_interval
...
def choice_task(event):
    if event == 'entry':
        ...
        disarm_timer('flash1_on')
        disarm_timer('flash1_off')

        disarm_timer('flash2_on')
        disarm_timer('flash2_off')

        disarm_timer('flash3_on')
        disarm_timer('flash3_off')

        disarm_timer('flash4_on')
        disarm_timer('flash4_off')

        disarm_timer('flash5_on')
        disarm_timer('flash5_off')
...
def all_states(event):
    ...
    elif event == 'flash1_on':
        hw.five_poke.poke_2.LED.on()
        hw.five_poke.poke_3.LED.on()
        hw.five_poke.poke_4.LED.on()
        hw.five_poke.poke_5.LED.on()
    elif event == 'flash1_off':
        hw.five_poke.poke_2.LED.off()
        hw.five_poke.poke_3.LED.off()
        hw.five_poke.poke_4.LED.off()
        hw.five_poke.poke_5.LED.off()

    elif event == 'flash2_on':
        hw.five_poke.poke_1.LED.on()
        hw.five_poke.poke_3.LED.on()
        hw.five_poke.poke_4.LED.on()
        hw.five_poke.poke_5.LED.on()
    elif event == 'flash2_off':
        hw.five_poke.poke_1.LED.off()
        hw.five_poke.poke_3.LED.off()
        hw.five_poke.poke_4.LED.off()
        hw.five_poke.poke_5.LED.off()

    elif event == 'flash3_on':
        hw.five_poke.poke_1.LED.on()
        hw.five_poke.poke_2.LED.on()
        hw.five_poke.poke_4.LED.on()
        hw.five_poke.poke_5.LED.on()
    elif event == 'flash3_off':
        hw.five_poke.poke_1.LED.off()
        hw.five_poke.poke_2.LED.off()
        hw.five_poke.poke_4.LED.off()
        hw.five_poke.poke_5.LED.off()

    elif event == 'flash4_on':
        hw.five_poke.poke_1.LED.on()
        hw.five_poke.poke_2.LED.on()
        hw.five_poke.poke_3.LED.on()
        hw.five_poke.poke_5.LED.on()
    elif event == 'flash4_off':
        hw.five_poke.poke_1.LED.off()
        hw.five_poke.poke_2.LED.off()
        hw.five_poke.poke_3.LED.off()
        hw.five_poke.poke_5.LED.off()

    elif event == 'flash5_on':
        hw.five_poke.poke_1.LED.on()
        hw.five_poke.poke_2.LED.on()
        hw.five_poke.poke_3.LED.on()
        hw.five_poke.poke_4.LED.on()
    elif event == 'flash5_off':
        hw.five_poke.poke_1.LED.off()
        hw.five_poke.poke_2.LED.off()
        hw.five_poke.poke_3.LED.off()
        hw.five_poke.poke_4.LED.off()