...
def all_states(event):
    ...
    if event == 'session_timer':
        print("Event Closing")
        print("Correct RT list: {}".format(v.correct_latency_list))
        print("Incorrect RT List: {}".format(v.incorrect_latency_list))
        print("RL List: {}".format(v.reward_latency_list))
        print("Premature RT List: {}".format(v.premature_response_latency_list))
        stop_framework()
