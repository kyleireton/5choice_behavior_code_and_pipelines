...
v.n_steps = 10                    # this is number of steps for stepper motor if you want to use peristaltic pump it will be 1000
v.state_dur = 0.8*second             # this state the duration of the choice_state#
v.LH_dur = 2*second                 # limited hold duration
v.reward_stimulation_dur = 3*second # Reward duration this duration
...
def start(event):
    ...
    if event =='entry':
        ...
        hw.syringe_pump.forward(v.steps_rate, v.n_steps*2.5)
